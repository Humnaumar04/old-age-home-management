    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-start space-x-4">
            ...
            <div class="flex-1">
                ...
                <p class="text-sm text-gray-500 mt-1">Health status, activities, and incidents for {{ date('F Y') }}</p>
                <p class="text-xs text-gray-400 mt-2">Generated: {{ date('M d, Y') }}</p>
                <a href="{{ route('admin.reports.resident') }}"
                    class="inline-flex items-center px-4 py-2 mt-3 bg-[#14434C] hover:bg-[#0e3037] text-white text-xs font-semibold rounded-lg shadow-md transition duration-200">
                    <!-- Download Icon (SVG) -->
        ...
        <!-- CARD 2: Donation & Funding Report -->
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-start space-x-4">
            <div class="p-3 bg-[#F8F6F0] rounded-xl text-xl flex items-center justify-center w-12 h-12">💰</div>
            <div class="flex-1">
        ...
        <!-- CARD 3: Volunteer Report -->
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-start space-x-4">
            <div class="p-3 bg-[#F8F6F0] rounded-xl text-xl flex items-center justify-center w-12 h-12">🤝</div>
            <div class="flex-1">
                <h3 class="font-bold text-lg text-[#1E4C56]">Volunteer Activity Report</h3>
                <p class="text-sm text-gray-500 mt-1">Sessions attended, hours contributed, and tasks completed</p>
                <p class="text-xs text-gray-400 mt-2">Generated: {{ date('M d, Y') }}</p>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-start space-x-4">
            ...
            <div class="flex-1">
                ...
                <p class="text-xs text-gray-400 mt-2">Generated: {{ date('M d, Y') }}</p>
                <a href="{{ route('admin.reports.emergency') }}"
                    class="inline-flex items-center px-4 py-2 mt-3 bg-[#14434C] hover:bg-[#0e3037] text-white text-xs font-semibold rounded-lg shadow-md transition duration-200">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
                    </svg>
